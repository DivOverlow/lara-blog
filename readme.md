...
php artisan make:model Model/admin/role -m
php artisan make:model Model/admin/admin_role -m
php artisan migrate
...
php artisan make:controller Backend/TagController --resource
...
3.
php artisan tinker
	App\Model\frontend\post::all()
	App\Model\frontend\post::find(1)->tags
...
7. php artisan make:controller Admin/RoleController --resource

php artisan route:list

8. php artisan make:model Model/admin/Permission -m -r

php artisan migrate
php artisan tinke
    >>> App\Model\admin\role::find(1)->permissions
    
php artisan tinker
    >>>App\Model\admin\admin::find(5)->roles    

9. php artisan make:policy PostPolicy --model=Post

10. php artisan make:migration likes
    php artisan migrate
    php artisan make:model Model/frontend/like